...
let verifyPhone = ()=>{
    ...
    let signUp = ()=>{
        let request = async ()=>{
            await axios.post("http://localhost:3000/seller/signup",{
                ...form
            }).then((res)=>{
    ...
    let signIn = ()=>{
        let request = async ()=>{
            await axios.post("http://localhost:3000/seller/signin",{
                ...form
            }).then((res)=>{
                if(res.data.state == true){
                    localStorage.setItem("mytoken",res.data.token);
        ...
        <>
            <div className="signCardForBuyers bg-white p-6 md:w-1/3 w-full rounded-lg flex flex-col items-center justify-center">
                ...
                <div className="row3 flex">
                    ...
                    <div>
                        <TextField id="outlined-basic" size='small' name='phoneOtp' value={form.phoneOtp} onChange={updatefun} label="Enter Number OTP" variant="outlined" />
                    </div>
                ...
                <div className="row5 flex">
                    ...
                    <div>
                        <TextField id="outlined-basic" size='small' name='emailOtp' value={form.emailOtp} onChange={updatefun} label="Enter Number OTP" variant="outlined" />
                    </div>
                ...
                <div className="row6 w-full flex flex-col m-2">
                    <TextField id="standard-basic" name='address' value={form.address} onChange={updatefun} label="Your Address" variant="standard" />
                </div>
                </>
                }
